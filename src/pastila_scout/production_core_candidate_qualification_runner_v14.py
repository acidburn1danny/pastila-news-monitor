...
EXPECTED_GENERATION = "65d5b2502c0ff3a30367cceccda2a2e5c772844cb70500445a186deebf1d4567"
EXPECTED_QUALIFICATION = "309facaf268c79cdf3e6c635bec47c46c68121b7b5eb543f07c801048386da13"


def verify_successor_identities(generation: str, qualification: str) -> None:
    """Reject historical or substituted schedules before model/runtime loading."""
    if generation != EXPECTED_GENERATION:
        raise SystemExit("qualification generation authority mismatch")
    if qualification != EXPECTED_QUALIFICATION:
        raise SystemExit("qualification identity authority mismatch")
...
def main() -> int:
    ...
    verify_successor_identities(
        os.environ["QUALIFICATION_GENERATION_IDENTITY"],
        os.environ["QUALIFICATION_IDENTITY"],
    )

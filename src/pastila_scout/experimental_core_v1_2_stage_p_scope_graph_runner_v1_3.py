"""Evaluation-only runner binding for the baseline-language diagnostic adapter."""
...
REQUEST_CANDIDATE_IDENTITY = "c6ab0e2f7721710af208c70ad96d31a412596b9ce69ee8f7f485caba5b620f08"
TOKENIZER_IDENTITY = "sha256:a91ae3f74fbc3b81c29c29c5e1567c4b018169af288989d5fca0089876f98a1c"
ADAPTER_IDENTITY = "57dad182098a4d92db6a4c61cef2e585a5e1534c7c3e0496d9d29d6cab0d3c7e"
...
def _diagnostic_types():
    ...
    controller = _load(prefix + "stage_p_scope_graph_diagnostic_callback_controller_v1",
                       semantic_root / "stage_p_scope_graph_diagnostic_callback_controller_v1.py")
    lifecycle = _load(prefix + "append_only_lifecycle_v1", semantic_root / "append_only_lifecycle_v1.py")
    return (dfa.StagePScopeGraphConstraintStateV1_2, projector.StagePDiagnosticTokenTrieProjectorV1,
            controller.StagePScopeGraphDiagnosticCallbackControllerV1, lifecycle.AppendOnlyLifecycleV1)


def main(arguments: list[str]) -> None:
    if len(arguments) != 4:
        raise SystemExit("usage: runner REQUEST RESPONSE PROMPT DURABLE_LIFECYCLE_ROOT")
    base = _load("pastila_stage_p_scope_graph_diagnostic_durable_runner_base",
                 ROOT / "src/pastila_scout/experimental_core_v1_2_stage_p_constrained_runner_v3.py")
    base._types = _diagnostic_types

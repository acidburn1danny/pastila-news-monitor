"""Evaluation-only Construction Role evaluator preserving typed liveness failure."""
...
SOURCE_EVALUATOR_BINDING_IDENTITY = "78a54899160921698fef98f9ac672d83015d08642a36aa67e3e559d6972eb9d6"
APPROVED_FAILURE_REVIEW_IDENTITY = "730b2e3ac7a067a51852edbcc57ba2fe9810264a85e35b090395b1a2a4bcff9a"


class StagePConstructionRoleEvaluatorV1_1:
    def __init__(self, *, project_root: Path, executor: DurableConstructionRoleStagePExecutorV1,
        ...
        if type(executor) is not DurableConstructionRoleStagePExecutorV1:
            raise TypeError("Construction Role evaluator V1.1 requires exact approved durable executor")
        ...
        parts = ["STAGE_P_CONSTRUCTION_ROLE_EVALUATOR_V1_1", self.candidate_identity,
                 SOURCE_EVALUATOR_BINDING_IDENTITY, APPROVED_FAILURE_REVIEW_IDENTITY,
    ...
    def __call__(self, request: dict[str, object]) -> str:
        ...
        if receipt is not None:
            raise StagePConstraintLivenessExecutionErrorV1(receipt)
...
__all__ = ("StagePConstructionRoleEvaluatorV1_1",)

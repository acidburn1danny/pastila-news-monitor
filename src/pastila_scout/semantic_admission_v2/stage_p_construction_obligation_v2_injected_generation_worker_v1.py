"""Launch-forbidden injected generation worker candidate.
...
def execute_injected_generation_worker_v1(
    *, raw_policy_receipt: bytes, raw_authority_receipt: bytes,
    ...
    parse_generation_authority_v1(
        ...
        expected_generation_candidate_identity=WORKER_IDENTITY,
...
__all__ = (
    "ConstraintLivenessStopV1", "InjectedCompatibleGenerationResourceV1",
    "InjectedGenerationOperationsV1", "InjectedGenerationOutputV1",
    "InjectedGenerationWorkerOutcomeV1", "WORKER_IDENTITY",
    "execute_injected_generation_worker_v1",
)

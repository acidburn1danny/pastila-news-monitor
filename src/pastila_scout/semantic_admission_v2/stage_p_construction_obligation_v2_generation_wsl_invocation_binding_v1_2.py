"""Build-only WSL invocation binding for the V1.2 Linux runner."""
...
GENERATION_WSL_INVOCATION_BINDING_IDENTITY_FIELDS = (
    "construction-obligation-v2-generation-wsl-invocation-binding-v1.2",
...
RUNNER_RELATIVE = Path("src/pastila_scout/semantic_admission_v2/stage_p_construction_obligation_v2_linux_generation_runner_v1_2.py")
RUNNER_MODULE = "pastila_scout.semantic_admission_v2.stage_p_construction_obligation_v2_linux_generation_runner_v1_2"
RUNNER_SOURCE_SHA256 = "e7d8f47012252894a443254fadb74f4cd7be81fe36ed3d8fa1837933f7e7085e"


def build_generation_wsl_invocation_v1_2(
...
__all__ = (
    ...
    "build_generation_wsl_invocation_v1_2",
)

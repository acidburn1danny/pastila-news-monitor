...
PACKET_RELATIVE = Path(
    ...
    "case01-successor-issuance-packet-v1-2-1-exact-operations-bound")
EVIDENCE_RELATIVE = Path(
    ".semantic-admission-v2-stage-p-construction-obligation-v2-case01-successor-v1-2-1-exact-operations-bound-evidence")
...
def materialize_case01_issuance_packet_v1_2_1(
    *, project_root: Path,
    ...
    evidence_root_identity = hashlib.sha256("\n".join((
        "STAGE_P_CONSTRUCTION_OBLIGATION_V2_CASE01_V1_2_1_EXACT_OPERATIONS_BOUND_EVIDENCE_ROOT",

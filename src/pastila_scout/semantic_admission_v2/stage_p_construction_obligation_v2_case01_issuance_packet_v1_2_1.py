...
PACKET_RELATIVE = Path(
    ...
    "case01-successor-issuance-packet-v1-2-1-packet-bound")
EVIDENCE_RELATIVE = Path(
    ".semantic-admission-v2-stage-p-construction-obligation-v2-case01-successor-v1-2-1-packet-bound-evidence")

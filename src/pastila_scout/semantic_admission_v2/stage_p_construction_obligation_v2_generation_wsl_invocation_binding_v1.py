...
RUNNER_RELATIVE = Path(
    ...
    "stage_p_construction_obligation_v2_linux_generation_runner_v1.py"
)
RUNNER_MODULE = (
    "pastila_scout.semantic_admission_v2."
    "stage_p_construction_obligation_v2_linux_generation_runner_v1"
)
RUNNER_SOURCE_SHA256 = (
    "61c2381d0dade8fb318c9395a5a53ffeee71a3082732b3aee7051d06126abb6a"
)
...
def build_generation_wsl_invocation_v1(
    *,
    project_root: Path,
    ...
    invocation = boundary.build_invocation(
        consumer_id="construction-obligation-v2-generation-v1",
    ...
    material = (
        "STAGE_P_CONSTRUCTION_OBLIGATION_V2_GENERATION_WSL_INVOCATION_INSTANCE_V1",
        GENERATION_WSL_INVOCATION_BINDING_IDENTITY,

...
from .stage_p_construction_obligation_v2_linux_child_process_adapter_v1_1 import (
...
from .stage_p_construction_obligation_v2_linux_generation_supervisor_candidate_v1_1 import (
    ...
    supervise_linux_generation_candidate_v1_1,
)
...
def run_linux_generation_composition_v1_1(
    *,
    ...
    child_operations = build_linux_child_process_operations_v1_1(
...
__all__ = (
    "LINUX_GENERATION_COMPOSITION_IDENTITY",
    "LinuxGenerationCompositionOutcomeV1",
    "run_linux_generation_composition_v1_1",
)

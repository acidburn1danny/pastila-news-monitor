"""Five-path Linux entrypoint for the V1.2 source binding."""
...
from .stage_p_construction_obligation_v2_linux_generation_composition_v1_2 import LinuxGenerationCompositionOutcomeV1_2, run_linux_generation_composition_v1_2

LINUX_GENERATION_RUNNER_IDENTITY_FIELDS = (
    "construction-obligation-v2-linux-generation-runner-v1.2",
...
def run_linux_generation_runner_v1_2(
    *, policy_receipt_path: Path, authority_receipt_path: Path,
    runner_request_path: Path, system_prompt_path: Path, evidence_root: Path,
    composition: Callable[..., LinuxGenerationCompositionOutcomeV1_2] = run_linux_generation_composition_v1_2,
...
def main(arguments: Sequence[str]) -> int:
    ...
    run_linux_generation_runner_v1_2(

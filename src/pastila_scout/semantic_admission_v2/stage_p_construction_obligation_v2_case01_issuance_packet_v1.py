"""Zero-execution materialization of the current Case 01 issuance packet."""
...
PACKET_RELATIVE = Path(
    ...
    "case01-successor-issuance-packet-v1")
EVIDENCE_RELATIVE = Path(
    ".semantic-admission-v2-stage-p-construction-obligation-v2-case01-successor-v1-evidence")
...
def materialize_case01_issuance_packet_v1(
    *, project_root: Path,
    ...
    if evidence_root.exists() or evidence_root.is_symlink():
        raise FileExistsError("CASE01_SUCCESSOR_EVIDENCE_ROOT_NOT_EXCLUSIVE")
    ...
    candidate_value = {
        ...
        "schema_version": "1.1.0", "receipt_status": "UNISSUED",

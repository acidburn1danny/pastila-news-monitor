...
LINUX_CHILD_PROCESS_ADAPTER_IDENTITY = (
    "e166f63ceafc21828c7191f57e43ffbfd2befa04fed6bcb12ee8b164432fc4be"
)
...
def build_linux_child_process_operations_v1_1(
    *,
    ...
    def start(
        ...
        process = context.Process(
            target=_run_linux_generation_child_v1_1,
            kwargs={
...
def _run_linux_generation_child_v1_1(
    *,
    invocation: LinuxGenerationChildInvocationV1,
    raw_policy_receipt: bytes,
    raw_authority_receipt: bytes,

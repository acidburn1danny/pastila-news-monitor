"""Prepared one-shot Scope Graph V1 Case 01 evaluation probe; not executed by this binding."""
...
from .stage_p_scope_graph_contract_v1 import ScopeGraphLedgerV1, validate_scope_graph_sources
from .stage_p_scope_graph_durable_executor_v1 import DurableScopeGraphStagePExecutorV1
from .stage_p_scope_graph_evaluator_v1 import StagePScopeGraphEvaluatorV1
...
RUNNER_BINDING_IDENTITY = "50ff74856f6c12719dfb3b452e940a09b8c920b46fc78f63fa2e71667191019c"
...
def construct(*, project_root: Path, evidence_root: Path):
    ...
    executor = DurableScopeGraphStagePExecutorV1(project_root=project_root,
                                                  durable_lifecycle_root=evidence_root / "durable-lifecycle")
    evaluator = StagePScopeGraphEvaluatorV1(project_root=project_root, executor=executor, timeout_seconds=240.0)
    binding = {"case_id": CASE_ID, "pack_sha256": PACK_SHA256,
               "factual_summary_sha256": case["factual_summary_sha256"],
               "candidate_sha256": case["candidate_sha256"], "runner_binding_identity": RUNNER_BINDING_IDENTITY,
...
def run(*, project_root: Path, evidence_root: Path):
    ...
    receipt = execute_and_capture_stage_p_v2(
        ...
        schema_validator=lambda data: ScopeGraphLedgerV1.model_validate_json(data, strict=True),

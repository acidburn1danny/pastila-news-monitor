"""Diagnostic-liveness callback controller for Creative Target DFA V1."""
...
from .stage_p_creative_target_incremental_tracker_v1 import StagePCreativeTargetIncrementalTrackerV1


class StagePCreativeTargetCallbackControllerV1:
    def __init__(self, *, projector: StagePDiagnosticTokenTrieProjectorV1) -> None:
        self.projector = projector
        self.tracker = StagePCreativeTargetIncrementalTrackerV1()
    ...
    def allowed(self, token_ids: Sequence[int], decode: Callable[[Sequence[int]], str]) -> ScopeGraphCallbackReceiptV1_1:
        ...
        return ScopeGraphCallbackReceiptV1_1(allowed, prefix.path, prefix.suffix_characters,
            len(prefix.decoded), prefix.state.mode, prefix.state.entry_count, self.tracker.rebuild_steps,
            self.tracker.incremental_steps, self.projector.cache_size)


__all__ = ("StagePCreativeTargetCallbackControllerV1",)

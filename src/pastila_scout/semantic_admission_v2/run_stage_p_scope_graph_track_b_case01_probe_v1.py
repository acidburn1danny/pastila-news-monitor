"""Prepared exclusive Track-B Case 01 probe; construction does not execute it."""
...
from .stage_p_scope_graph_track_b_evaluator_v1 import StagePScopeGraphTrackBEvaluatorV1
...
EVALUATOR_BINDING_IDENTITY = "c94bcf9ffed5d33223d31d9b2d1014b0595b15422af86cfb3581c8022b85e4a7"
...
def construct(*, project_root: Path, evidence_root: Path):
    ...
    evaluator = StagePScopeGraphTrackBEvaluatorV1(project_root=project_root, executor=executor,
                                                  timeout_seconds=240.0)
    if evaluator.evaluator_identity != EVALUATOR_BINDING_IDENTITY:
        raise RuntimeError("Track-B evaluator binding drift")
    binding = {

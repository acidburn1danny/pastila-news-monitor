...
from .stage_p_construction_obligation_v2_injected_generation_worker_v1_2 import (
    InjectedGenerationOperationsV1,
    execute_injected_generation_worker_v1_2,
)
...
def supervise_injected_generation_v1_2(
    *, raw_policy_receipt: bytes, raw_authority_receipt: bytes,
    ...
    outcome = execute_injected_generation_worker_v1_2(

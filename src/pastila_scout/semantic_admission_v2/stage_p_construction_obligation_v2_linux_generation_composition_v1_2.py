"""V1.2 Linux composition with early bound failure evidence."""
...
LINUX_GENERATION_COMPOSITION_IDENTITY_FIELDS = (
    "construction-obligation-v2-linux-generation-composition-v1.2",
    "child-adapter:v1.2",
...
def run_linux_generation_composition_v1_2(
    *, raw_policy_receipt: bytes, raw_authority_receipt: bytes,
    ...
    try:
        child = build_linux_child_process_operations_v1_2(
...
__all__ = (
    ...
    "LINUX_GENERATION_COMPOSITION_IDENTITY_FIELDS",
    "LinuxGenerationCompositionOutcomeV1_2",
    "run_linux_generation_composition_v1_2",
)

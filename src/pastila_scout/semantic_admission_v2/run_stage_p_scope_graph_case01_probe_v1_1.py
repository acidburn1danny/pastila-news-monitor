"""Prepared one-shot Scope Graph V1.1 Case 01 probe; not executed by this binding."""
...
from .stage_p_scope_graph_durable_executor_v1_1 import DurableScopeGraphStagePExecutorV1_1
from .stage_p_scope_graph_evaluator_v1_1 import StagePScopeGraphEvaluatorV1_1
...
RUNNER_BINDING_IDENTITY = "57891ab6d928cde37a7d388e2f97a3da87d130e8debc1ab29b90bec850dc288a"
...
def construct(*, project_root: Path, evidence_root: Path):
    ...
    executor = DurableScopeGraphStagePExecutorV1_1(project_root=project_root,
        durable_lifecycle_root=evidence_root / "durable-lifecycle")
    evaluator = StagePScopeGraphEvaluatorV1_1(project_root=project_root, executor=executor, timeout_seconds=240.0)
    binding = {"case_id": CASE_ID, "pack_sha256": PACK_SHA256,
        ...
        "runner_binding_identity": RUNNER_BINDING_IDENTITY, "request_candidate_identity": evaluator.candidate_identity,
        ...
        "repair_count": 0, "selection_count": 0, "stage_c_constructed": False, "stage_c_called": False}
...
def run(*, project_root: Path, evidence_root: Path):
    ...
    receipt = execute_and_capture_stage_p_v2(evaluator=evaluator, request=request,

...
GENERATION_IDENTITY = "ccb426a8dd5f062794056a164fe815ab59af45db6166a1340853ead42a55e528"
QUALIFICATION_IDENTITY = (
    "535be0b80908bb6c2226996973d30f5ebb3413da80b9d78b7c71a08843c6d81a"
)
...
ALIAS_SECRET_COMMITMENT = (
    "08ac67b1516e72080eacd49fd08dff6adbe1c0f80c2b0313bc24f4052955a27b"
)
EXPECTED_OBJECTS = (
    (
        "rootfs",
    ...
    (
        "adapter_v1_1",
        "flat-dir",
        "0bc4bb1b83b5c1375c1e676844dea079831e7ad0b90db955fa89a2f7d65c3e47",
    ),
    (
        "adapter_v1_2",
        "flat-dir",
        "22b5a7bde7194c66d895b9acab5791a8d8573df67f93704eab933666df7978a2",
    ),
)
...
def validate_completion(
    ...
    for row in expected_rows:
        ...
        if receipt_raw != canonical(receipt) or observation_raw != canonical(observation):
        ...
        adapters = {
            "pastila-editor-core-v1.1-experimental": EXPECTED_OBJECTS[2][2],
            "pastila-editor-core-v1.2-experimental": EXPECTED_OBJECTS[3][2],
        }
        prompts = {
            "pastila-editor-core-v1.1-experimental": "9b25e239fc227252906fecab393a42a82eca4baa643ceed28177d3c5054e93fc",
            "pastila-editor-core-v1.2-experimental": "111bc2734343c67aab4e1a04003199b98d4955fe9579e445cd7b5d6805a9da17",
        ...
        if (
            ...
            or receipt["observation_identity"]
    ...
    for directory, batch_rows in batches.items():
        ...
        try:
            ...
            raise ExecutionAuthorityError("completion boundary evidence absent") from exc

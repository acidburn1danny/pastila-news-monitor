"""Dedicated offline worker for the 48-row Editor Core targeted R3 round."""
...
EXPECTED_STEPS = 6
CHECKPOINT_STEPS = (6,)
EXPECTED_CONFIG_IDENTITY = "c5c91295e19865b4a063570cf7a2186f1a8cd10dbe61da7618aab435d8a80db7"
...
def validate_config(config: dict[str, object], corpus_sha256: str, row_count: int) -> dict[str, object]:
    ...
    expected = {
        ...
        "candidate": "pastila-editor-core-v1.2-json-successor-targeted-r3",
...
def fixture_smoke(config: dict[str, object]) -> dict[str, object]:
    ...
    core = {"schema": "pastila-editor-core-targeted-r3-worker-fixture-smoke", "schema_version": 1, "status": "PASS_FIXTURE_ONLY", **plan, "model_loaded": False, "optimizer_created": False, "optimizer_steps_executed": 0, "training_performed": False}

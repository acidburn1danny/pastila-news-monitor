"""Deterministic inference-only runner for the R2 independent holdout."""
...
def run(model_path: Path, adapter_path: Path, requests_path: Path, output: Path, candidate: str) -> dict[str, object]:
    ...
    core = {
        "schema": "pastila-editor-core-targeted-r2-holdout-inference-receipt", "schema_version": 1,
...
def fixture_smoke(requests: list[dict[str, object]]) -> dict[str, object]:
    ...
    core = {"schema": "pastila-editor-core-targeted-r2-holdout-fixture-smoke", "schema_version": 1, "rows": 2, "model_loaded": False, "inference_performed": False, "training_performed": False}

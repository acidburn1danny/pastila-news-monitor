"""Zero-step launcher validation for the Editor Core targeted R5 round.
...
ACTIVE_COMMIT = "a95ca513f32467ba771e699095ae8c34a89f570b"
ACTIVE_TREE = "ec2cd918574c746989e98fb31b17183d5270fbe9"
...
DATASET_MANIFEST = "1cb2afd04273089c6f7943369c9b158182c5efdccf003f45f85b87fd2881f769"
TRAINING_CONFIG = "1781cc93fb9de7c5d88a37af8286f36874beb646df5c3b12383e7b4eb2c55e34"
...
PUBLISHED_FILES = (
    "docs/artifacts/editor-core-v10-v12-targeted-continuation-r5-holdout-answer-key.jsonl",
    "docs/artifacts/editor-core-v10-v12-targeted-continuation-r5-holdout-requests.jsonl",
    "docs/artifacts/editor-core-v10-v12-targeted-continuation-r5-manifest.json",
    "docs/artifacts/editor-core-v10-v12-targeted-continuation-r5-new-train.jsonl",
    "docs/artifacts/editor-core-v10-v12-targeted-continuation-r5-replay-anchors.jsonl",
    "docs/artifacts/editor-core-v10-v12-targeted-continuation-r5-token-audit.json",
    "docs/artifacts/editor-core-v10-v12-targeted-continuation-r5-training-config.json",
    "docs/artifacts/editor-core-v10-v12-targeted-continuation-r5-training.jsonl",
    "docs/editor-core-v10-v12-targeted-r5-development-pack.md",
    "scripts/audit_editor_core_v10_v12_targeted_r5_pack.py",
    "scripts/audit_editor_core_v10_v12_targeted_r5_token_lengths.py",
    "scripts/build_editor_core_v10_v12_targeted_r5_pack.py",
    "scripts/run_editor_core_v10_v12_targeted_r5_token_audit.sh",
    "tests/test_editor_core_v10_v12_targeted_r5_pack.py",
)
...
def validate_public_inputs() -> tuple[dict[str, object], dict[str, object], dict[str, object]]:
    ...
    audit_module = load_script(ROOT / "scripts" / "audit_editor_core_v10_v12_targeted_r5_pack.py", "targeted_r5_audit")
    ...
    if (
        ...
        or config.get("rejected_r3_r4_adapter_training_use") is not False
    ):

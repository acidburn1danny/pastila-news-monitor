"""Mechanism-neutral Governance V2 G02C review for Pilot 04 candidate 01."""
...
G02_COMMIT = "9504f5f5c4dee0bcd07db7d4b582630d21b871a1"
...
G02_PATH = "docs/artifacts/humor-mechanics-batch2-development-pilot04-candidate01-g02-v1.json"
...
def main() -> None:
    receipt_path = ART / "humor-mechanics-batch2-development-pilot04-candidate01-g02c-conformance-receipt-v1.json"
    review_path = ART / "humor-mechanics-batch2-development-pilot04-candidate01-g02c-review-v1.json"
    ...
    require(g02["g02_verdict"] == "PASS" and g02["g02_receipt_identity"] == "d1e339796733a75423b4255bc90fc440c5c572ada4628954258f92ecde963cd3", "G02")
    require(hashlib.sha256(candidate).hexdigest() == "e231a549685103da5c6e0e4f9b9e93459d86e7c7ae0247ad11f15d55a3426b0b", "candidate")
    ...
    ss, se = p5["supporting_span"]["character_coordinates"]
    exact = source[ss:se]
    require(text.startswith(exact + " "), "authorized proposition")
    marker = "În povestea expoziției"
    step1 = "un participant cu o astfel de acreditare rămâne mai întâi în afara zonei B"
    step2 = "neputând ajunge la demonstrație, ajunge apoi să demonstreze, chiar de la poartă, cât de bine funcționează interdicția"
    ...
    relation_core = {"proposition_id": "P5", "source_relation": {
        key: {"character_coordinates": p5[key]["character_coordinates"],
              "utf8_byte_coordinates": p5[key]["utf8_byte_coordinates"], "sha256": p5[key]["sha256"]}
        for key in ("subject", "predicate", "object")}}
    receipt_core = {
        "schema_name": "batch2-development-pilot04-g02c-conformance-receipt-v1", "schema_version": "2.0.0",
        ...
        "selected_proposition": {"proposition_id": "P5", "source_span": p5["supporting_span"]},
    ...
    receipt_id = seal("B2_DEVELOPMENT_PILOT04_G02C_CONFORMANCE_RECEIPT_V2", receipt_core)
    receipt = {**receipt_core, "conformance_receipt_identity": receipt_id}
    review_core = {
        "schema_name": "batch2-development-pilot04-candidate-g02c-review-v1", "schema_version": "2.0.0",
    ...
    review = {**review_core, "g02c_review_identity": seal("B2_DEVELOPMENT_PILOT04_G02C_REVIEW_V1", review_core)}

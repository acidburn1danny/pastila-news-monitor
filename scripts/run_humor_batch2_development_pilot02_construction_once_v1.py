"""Consume exactly one Pilot 02 capability and freeze its observed result."""
...
RELEASE_COMMIT = "3c43dc0da1e4f1c3f0e91dd62991afcf50724f01"
EXECUTION_SOURCE_COMMIT = "f62fb673dba95c9a61d9808c36e7c72354978000"
RELEASE_PATH = "docs/artifacts/humor-mechanics-batch2-development-pilot02-constructor-access-release-v1.json"
...
CANDIDATE = ROOT / "docs/artifacts/humor-mechanics-batch2-development-pilot02-candidate01-v1.txt"
EVIDENCE = ROOT / "docs/artifacts/humor-mechanics-batch2-development-pilot02-construction-attempt01-v1.json"
ACCESS_SOURCE_SHA256 = "fedb048c9229d049e08fda464caa533181d2eeacbb95dac2cf0a8f8fd5e1747e"
CONSTRUCTOR_SOURCE_SHA256 = "dac97375c91a1c0858264d25313262d22189be0527fe44991acececd134d1d26"
...
def main() -> None:
    if CANDIDATE.exists() or EVIDENCE.exists():
        raise SystemExit("Pilot 02 construction attempt already consumed")
    ...
    if prepared.release_identity != "13beb154aced8cb5a63145fe84fd4b8da7ab357147c981e55f76863c9d6caced":
        raise SystemExit("release identity")
    if prepared.packet_identity != "0b627771abf337f95cd9f21a732fad90edcee6d3386187c28273de567e8e6ab9":
    ...
    if result.terminal_classification == "CANDIDATE_PRODUCED" and result.candidate_surface_utf8 is not None:
        ...
        candidate_identity = seal("B2_DEVELOPMENT_PILOT02_CANDIDATE_V1", {
    ...
    core = {
        "schema_name": "batch2-development-pilot02-construction-attempt01-v1",
        "schema_version": "1.0.0",
        "execution_source_commit": EXECUTION_SOURCE_COMMIT,
        "constructor_access_source_sha256": ACCESS_SOURCE_SHA256,
        ...
        "construction_provenance": {
            "source_sha256": packet["source_object"]["sha256"],
        ...
        "authority_matrix": {key: False for key in (
            "owner_freeze", "mechanism_adjudication", "model_training", "runtime_integration", "production_routing")},
    }
    evidence = {**core, "evidence_identity": seal("B2_DEVELOPMENT_PILOT02_CONSTRUCTION_ATTEMPT01_V1", core)}

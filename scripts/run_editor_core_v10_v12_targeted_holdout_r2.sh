...
[[ ${EDITOR_CORE_R2_EVALUATION_OWNER_AUTHORIZED:-0} == 1 ]] || exit 3
...
EXPECTED_REQUESTS=2b56edeea672e82ab3fa67cfc1f6af8378389a615602773f8fccf6e45de159c9
EXPECTED_RUNNER=539c122f9a3159a67da40dd0e9168f0b2b67f0eeb21705144ac0408abe2b4bad
case "$CANDIDATE" in
  r1-checkpoint-8) EXPECTED_ADAPTER=50b292f9cfdfb2f44dcc8bb9ef811ea367c78db505e4adc2c62e851e6060d3a4 ;;
...
WORK="$(mktemp -d /tmp/editor-targeted-r2-eval.XXXXXXXX)"; ROOTFS="$WORK/rootfs"; mkdir "$ROOTFS"; child=""

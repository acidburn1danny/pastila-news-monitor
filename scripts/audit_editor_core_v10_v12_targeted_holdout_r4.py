"""Read-only closure and comparison audit for R4 holdout outputs."""
...
SEMANTIC_MARKERS = {
    "ATTRIBUTION_DENIAL_FINALITY": (("suspiciun",), ("ar fi", "posibil"), ("neag",), ("final",)),
    "PRELIMINARY_CONTEST_PENDING": (("ar fi", "intermediar", "provizori"), ("obiec",), ("deschis", "continu", "nesoluționat", "nesoluționată", "fără concluzie finală")),
}
...
def audit(output: Path, answer_key: Path, candidate: str, adapter_sha256: str, requests_sha256: str, runner_sha256: str) -> dict[str, object]:
    ...
    core = {
        "schema": "pastila-editor-core-targeted-r4-holdout-audit", "schema_version": 1,
...
def compare(left: Path, right: Path, answer_key: Path) -> dict[str, object]:
    ...
    core = {
        "schema": "pastila-editor-core-targeted-r4-holdout-comparison", "schema_version": 1,

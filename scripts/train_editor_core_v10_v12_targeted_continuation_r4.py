"""Dedicated offline worker for the 48-row Editor Core targeted R4 round."""
...
EXPECTED_STEPS = 6
CHECKPOINT_STEPS = (6,)
EXPECTED_CONFIG_IDENTITY = "ff56af658234f6168aeb1c541600860ecda72172c7f663098da7b1751a8274a1"
EXPECTED_CORPUS = "464fdd6fa3769e665ba52e7fb12f659ebac5255a711864a7eda0cc44ae22edbc"
...
def validate_config(config: dict[str, object], corpus_sha256: str, row_count: int) -> dict[str, object]:
    ...
    expected = {
        ...
        "candidate": "pastila-editor-core-v1.2-json-successor-targeted-r4",
        ...
        "rejected_r3_adapter_training_use": False,
...
def run_training(model_path: Path, parent_path: Path, corpus_path: Path, config_path: Path, output: Path) -> dict[str, object]:
    ...
    receipt = {"schema": "pastila-editor-core-targeted-r4-training-receipt", "schema_version": 1, **authority, "optimizer": "PAGED_ADAMW_8BIT_NEW_STATE", "optimizer_steps": steps, "checkpoint_identities": checkpoints, "final_loss": format(losses[-1], ".17g"), "network_activity": False, "holdout_used": False, "r4_used": False, "adjudication_performed": False, "promotion": False}
...
def fixture_smoke(config: dict[str, object]) -> dict[str, object]:
    ...
    core = {"schema": "pastila-editor-core-targeted-r4-worker-fixture-smoke", "schema_version": 1, "status": "PASS_FIXTURE_ONLY", **plan, "model_loaded": False, "optimizer_created": False, "optimizer_steps_executed": 0, "training_performed": False}

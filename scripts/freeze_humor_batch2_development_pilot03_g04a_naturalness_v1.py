"""Freeze the blind Romanian-naturalness review for Pilot 03 candidate 01."""
...
G03C_COMMIT = "f997676afef9e93514f071b5baa7475e30664569"
CANDIDATE_PATH = "docs/artifacts/humor-mechanics-batch2-development-pilot03-candidate01-v1.txt"
G03C_RECEIPT_PATH = "docs/artifacts/humor-mechanics-batch2-development-pilot03-candidate01-g03c-receipt-v1.json"
...
def main() -> None:
    ...
    require(g03c["g03c_diagnostic_identity"] == "b979f338a5df5c806b006c3cd797309dc98ade2937c955caa7aa9961f346b4e5", "diagnostic identity")
    require(g03c["g03c_receipt_identity"] == "ae9598814cf8a56c3a2ae4ff2a64c82cbcc4d82eeb376a3268fed8b8d74cde16", "receipt identity")
    ...
    core = {
        "schema_name": "batch2-development-pilot03-candidate01-g04a-romanian-naturalness-review-v1",
        ...
        "findings": {
            ...
            "idiomatic_word_order_and_register": {"verdict": "PASS_WITH_RESERVATION", "finding": "Registrul de inventar este deliberat tehnic, dar ordinea cuvintelor și progresia rămân firești; abstracția «necunoașterea conținutului» este ușor rigidă, nu material nenaturală."},
            "no_calque": {"verdict": "PASS", "finding": "Nu apare un calc identificabil sau o construcție sintactică străină de română."},
            "natural_creative_marking": {"verdict": "PASS", "finding": "«În povestea imaginară a coletului» marchează explicit planul nonfactual în interiorul enunțului, fără eticheta metadiscursivă de guvernanță respinsă la Pilot 02."},
            "no_forced_wordplay": {"verdict": "PASS", "finding": "Repetiția lexicală «inventar/inventariat» susține poanta categorială și nu forțează o asemănare fonetică sau un sens inexistent."},
            "cohesion_and_punctuation": {"verdict": "PASS", "finding": "Punctul și virgula separă adecvat cele două trepte, iar «cum» leagă inteligibil cauza locală de concluzie."},
            "overall_naturalness": {"verdict": "PASS", "finding": "Textul este idiomatic și coerent pentru o miniatură umoristică cu registru tehnic; rezerva minoră de abstractizare nu împiedică naturalețea."},
        },
        ...
        "authority_matrix": {key: False for key in ("voice_review", "owner_review", "candidate_repair", "candidate_rewrite", "candidate_regeneration", "training", "runtime_integration", "production_routing", "curriculum_promotion")},
    }
    review = {**core, "g04a_review_identity": seal("B2_DEVELOPMENT_PILOT03_CANDIDATE01_G04A_NATURALNESS_REVIEW_V1", core)}
    receipt_core = {
        "schema_name": "batch2-development-pilot03-candidate01-g04a-romanian-naturalness-receipt-v1",
        "schema_version": "1.0.0",
    ...
    receipt = {**receipt_core, "g04a_receipt_identity": seal("B2_DEVELOPMENT_PILOT03_CANDIDATE01_G04A_NATURALNESS_RECEIPT_V1", receipt_core)}
    for name, value in (("humor-mechanics-batch2-development-pilot03-candidate01-g04a-naturalness-review-v1.json", review), ("humor-mechanics-batch2-development-pilot03-candidate01-g04a-naturalness-receipt-v1.json", receipt)):

"""Audit and prepare Pilot 06's pathless G02B constructor-access release."""
...
COMMIT = "c2aea939a22e6e0dd3e33f05e43a8d1f0796e4d4"
...
MAPPING_PATH = "docs/artifacts/humor-mechanics-batch2-development-pilot06-sealed-rebalancing-assignment-v2.json"
AUDIT_PATH = "docs/artifacts/humor-mechanics-batch2-development-pilot06-rebalancing-assignment-design-audit-v2.json"
...
def main() -> None:
    ...
    require(prior["constructor_facing_packet_identity"] == "206645473d3dd479ea0cdadc88fff9f4f8d487e0ecdde50d9618d288c10cff86", "packet")
    require(mapping["sealed_assignment_identity"] == "c45e19fd9416d50ac4776c1352c7afe5657501545f6405d9e2d4ba33f2b505a9", "mapping")
    require(prior_audit["audit_identity"] == "eaffd1c6aeeb4470cda6ed33aa75aa19e589f2cd995004ad438cc6a84bfaacea", "audit")
    require(prior["selected_proposition_id"] == "P3" and len(prior["closed_factual_authority_envelope"]["propositions"]) == 1, "P3 only")
    ...
    packet_id = seal("B2_DEVELOPMENT_PILOT06_CONSTRUCTOR_PACKET_G02B_V2", core)
    ...
    release_core = {
        ...
        "packet_seal_namespace": "B2_DEVELOPMENT_PILOT06_CONSTRUCTOR_PACKET_G02B_V2",
    ...
    release_id = seal("B2_DEVELOPMENT_PILOT06_CONSTRUCTOR_ACCESS_RELEASE_V2", release_core)
    release = {
        "schema_name": "batch2-development-pilot06-constructor-access-release-v2",
    ...
    forbidden = [rb"HMCV1", rb"M13", rb"ABSURD_LOGICAL_EXTENSION", rb"Absurd Logical Extension", rb"MISDIRECTION", rb"ESCALATION", rb"HYPERBOLE",
    ...
    require(packet["selected_proposition_id"] == "P3" and len(packet["closed_factual_authority_envelope"]["propositions"]) == 1, "visible scope")
    ...
    audit_core = {
        "schema_name": "batch2-development-pilot06-g02b-preconstruction-audit-v2",
        "schema_version": "2.0.0",
        ...
        "selected_proposition_and_span_binding": "PASS_EXACT_P3_ONLY",
    ...
    audit = {**audit_core, "audit_identity": seal("B2_DEVELOPMENT_PILOT06_G02B_AUDIT_V2", audit_core)}
    write("humor-mechanics-batch2-development-pilot06-constructor-facing-assignment-g02b-v2.json", packet)
    write("humor-mechanics-batch2-development-pilot06-constructor-access-release-v2.json", release)
    write("humor-mechanics-batch2-development-pilot06-g02b-preconstruction-audit-v2.json", audit)
    print(json.dumps({"verdict": audit["verdict"], "constructor_facing_packet_identity": packet_id,
                      ...
                      "selected_proposition": "P3", "constructor_invocations": 0}, sort_keys=True))

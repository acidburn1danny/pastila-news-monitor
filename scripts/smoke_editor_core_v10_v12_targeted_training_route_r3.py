"""Fixture-only smoke for the R3 targeted training worker and bound route."""
...
FIXTURE = ROOT / "tests/fixtures/editor_core_targeted_training_route_r3/training-config.json"


def run() -> dict[str, object]:
    spec = importlib.util.spec_from_file_location("targeted_r3_worker", WORKER)

...
def main() -> int:
    ...
    a = parser.parse_args()
    target = ("preflight_production_core_candidate_qualification_v15_bound.py" if a.preflight_only
              else "execute_production_core_candidate_qualification_v15_bound.py")

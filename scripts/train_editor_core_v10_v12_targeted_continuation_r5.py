"""Dedicated offline worker for the 36-row Editor Core targeted R5 round."""
...
EXPECTED_STEPS = 6
CHECKPOINT_STEPS = (6,)
EXPECTED_CONFIG_IDENTITY = "1781cc93fb9de7c5d88a37af8286f36874beb646df5c3b12383e7b4eb2c55e34"
EXPECTED_CORPUS = "d0c0538bc5284f90f046c4a1339da90b07d2d612a0505375c28d3f1aa5cf8311"
...
def validate_config(config: dict[str, object], corpus_sha256: str, row_count: int) -> dict[str, object]:
    ...
    expected = {
        ...
        "candidate": "pastila-editor-core-v1.2-json-successor-targeted-r5",
        ...
        "shuffle": True,
        "seed": 314159,
        "r2_holdout_training_use": False,
        "r3_holdout_training_use": False,
        "r4_holdout_training_use": False,
        "rejected_r3_r4_adapter_training_use": False,
...
def run_training(model_path: Path, parent_path: Path, corpus_path: Path, config_path: Path, output: Path) -> dict[str, object]:
    ...
    receipt = {"schema": "pastila-editor-core-targeted-r5-training-receipt", "schema_version": 1, **authority, "optimizer": "PAGED_ADAMW_8BIT_NEW_STATE", "optimizer_steps": steps, "checkpoint_identities": checkpoints, "final_loss": format(losses[-1], ".17g"), "network_activity": False, "holdout_used": False, "rejected_r3_r4_adapter_training_use": False, "adjudication_performed": False, "promotion": False}
...
def fixture_smoke(config: dict[str, object]) -> dict[str, object]:
    ...
    core = {"schema": "pastila-editor-core-targeted-r5-worker-fixture-smoke", "schema_version": 1, "status": "PASS_FIXTURE_ONLY", **plan, "model_loaded": False, "optimizer_created": False, "optimizer_steps_executed": 0, "training_performed": False}

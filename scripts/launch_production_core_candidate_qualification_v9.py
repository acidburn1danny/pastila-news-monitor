...
SIGNED_BINDING = ART / "production-core-candidate-execution-authority-v9.binding.json"
DETACHED_SIGNATURE = ART / "production-core-candidate-execution-authority-v9.binding.sig"
EXECUTOR_SHA = "9869bfcb65da5a189013f1b56ca3f914c86872bad59c2997d1d4c59ab97239f7"
CORE_SHA = "5616841ee9dfc3c174d100aed07c79419df8850c0f63fbd7add9b1fd527ef33b"
...
ARTIFACTS = {
    "production-core-successor-comparative-qualification-generation-v9.json": "e7ff0930b99a4145c4b77b4a3ba0a163edf7f757943a85b93780cdfbef6a0a97",
    "production-core-candidate-request-manifest-v2.json": "b07d11975e558056a9350c75522c7d2fce2b9e6e924ea2a691cf76d70eb652d6",
    "production-core-successor-candidate-object-manifest-v9.json": "f3505bdf6cecf94b9081028c6ac4af1ee35012daf7fd3b97451b94c85b1ad0ab",
    "production-core-successor-candidate-generation-qualification-v9.json": "924383035ef35df80cbaa98d9cdf187ecb639e580030746392d5361fcac52c90",
}
...
def main():
    ...
    mechanism_raw = read(
        ART / "production-core-candidate-execution-authority-v9.json"
    )
    ...
    expected_authority = {
        ...
        "candidate_audit_receipt_identity": "b1915eed044bb05a00e977188dae9a6d7227169e3f1b12731075e1cc691e59f3",
    }
    if (
        tuple(binding)
        != (
        ...
        != "pastila-production-core-v9-detached-authority-binding"
    ...
    if (
        ...
        or mechanism.get("schema_version") != 10
        or mechanism.get("status")
        != "FROZEN_SUCCESSOR_V9_DUAL_STRUCTURAL_REMEDIATION_ZERO_ATTEMPTS"
        ...
        or mechanism.get("predecessor_root_cause_addendum_identity") is not None
        ...
        != sources.get("scripts/launch_production_core_candidate_qualification_v9.py")

...
[[ ${EDITOR_CORRECTIVE_EVAL_OWNER_AUTHORIZED:-0} == 1 ]] || exit 3
...
EXPECTED_REQUESTS=f97815679124cf040d0f7da5c010052532b6d8e08a71ff7ea2071de9035ddf11
EXPECTED_WORKER=88a6ed2ac07c10bdd79994eadb6e20075dc683e69951f68efaafff440edb287a
EXPECTED_CONSTRAINT=5c98158062dcf19d484a641b456b509bdcca1e5d21eba14754977bbd6a36ba6c
case "$CANDIDATE" in
  blind-candidate-x) EXPECTED_ADAPTER=bbb29efa47db05004a07b8d01c6170d2f0de7f67f0956a4a92e008563ba752a3 ;;
...
WORK="$(mktemp -d /tmp/editor-factual-corrective-eval.XXXXXXXX)"; ROOTFS="$WORK/rootfs"; mkdir "$ROOTFS"; child=""

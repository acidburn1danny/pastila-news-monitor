...
[[ ${EDITOR_CORE_R6_TRAINING_OWNER_AUTHORIZED:-0} == 1 ]] || exit 3
...
ZERO_STEP=/mnt/c/pf9/scripts/launch_editor_core_v10_v12_targeted_r6_zero_step.py
REPOSITORY=/mnt/c/pf9
EXPECTED_SOURCE_COMMIT=6494e127b84c67ca7ed2d14ec2ba95cd2195b7e1
EXPECTED_SOURCE_TREE=0f9cdd4d2e8362f036c4d640ea591e637aad39d4
...
EXPECTED_CONFIG=8fd68347f0a88f6da77b53385854b2e45d56f65041d373e02453cc05c0ccb682
EXPECTED_HELPER=7026fe0ea99d54d0fc6caefd5ac4b6c1119e488b1cdc96336ce14387b7ffb433
EXPECTED_ZERO_STEP=878a8aa0a79b6694114a02b9dced0967f7f364a6fa9f7c945928d42ec97ad944
EXPECTED_WORKER=01aadcfca6e193ba68b7cf50f548a1ea5fb51df8630c6418283310ef1a169dfb
...
WORK="$(mktemp -d /tmp/editor-targeted-r6-train.XXXXXXXX)"; ROOTFS="$WORK/rootfs"; mkdir "$ROOTFS"; child=""

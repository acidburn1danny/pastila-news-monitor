...
[[ ${EDITOR_CORE_EVALUATION_OWNER_AUTHORIZED:-0} == 1 ]] || exit 3
...
EXPECTED_REQUESTS=e4d6815fec1fd9e0e1f4c011f86bc14d8522a9a0f6d36d713c1bb7542fd9f448
EXPECTED_RUNNER=b75d0304bd13065c53579d169e8001e1147c63dabb0be1833ef2f886eb39115c
case "$CANDIDATE" in
  parent-v10-v1.2) EXPECTED_ADAPTER=8c277a123fef81908f03bdaf31925b93c1a95a3c0969ef23088331427e64013f ;;
  targeted-step-8) EXPECTED_ADAPTER=50b292f9cfdfb2f44dcc8bb9ef811ea367c78db505e4adc2c62e851e6060d3a4 ;;
  targeted-step-16) EXPECTED_ADAPTER=15a72fa1a2a7a27c99dbd727c1419ee668f5b245f92f2427409c43a8720eb6fd ;;
  *) exit 4 ;;
esac
...
WORK="$(mktemp -d /tmp/editor-targeted-eval.XXXXXXXX)"; ROOTFS="$WORK/rootfs"; mkdir "$ROOTFS"; child=""

"""Freeze the content-free owner-input package for DEVELOPMENT Pilot 04."""
...
PILOT03_FREEZE_COMMIT = "4395f3300ca2f59ce1f76b4e7abccd3ff0a587e9"
...
def main() -> None:
    ...
    require(head == PILOT03_FREEZE_COMMIT, "HEAD differs from Pilot 03 owner freeze")
    owner_freeze = json.loads(subprocess.check_output(["git", "show", f"{PILOT03_FREEZE_COMMIT}:docs/artifacts/humor-mechanics-batch2-development-pilot03-candidate01-g05-owner-freeze-v1.json"], cwd=ROOT))
    ...
    require(owner_freeze["g05_owner_freeze_identity"] == "b85401270daeb2025d79bc13d1d002e3d439171de72aef77f87ad5d7395b814b", "Pilot 03 freeze")
    require(owner_freeze["eligibility"]["pool_status"] == "POOL_PENDING_INSUFFICIENT_INDEPENDENT_POSITIVE_FAMILIES", "pool status")
    ...
    template_core = {
        ...
        "pilot_id": "BATCH2-INTERNALLY-OWNED-DEVELOPMENT-PILOT-04",
        "source": {
            "filename": "owner-source-pilot04-v1.txt", "declared_encoding": "UTF-8", "bom": False,
        ...
        "source_status_declarations": {
            ...
            "source_has_no_revision_sibling_same_event_or_syndication_relationship_with_pilots_01_02_03": "OWNER_MUST_CHOOSE_BOOLEAN",
            "source_does_not_reuse_pilots_01_02_03_wording_entities_events_or_creative_structures": "OWNER_MUST_CHOOSE_BOOLEAN",
    ...
    template = {**template_core, "template_identity": seal("B2_DEVELOPMENT_PILOT04_OWNER_DECLARATION_TEMPLATE_V1", template_core)}
    request_core = {
        "schema_name": "batch2-development-pilot04-owner-input-request-v1", "schema_version": "1.0.0",
        "status": "BLOCKED_AWAITING_OWNER_INPUT", "preparation_verdict": "PASS_CONTENT_FREE_METADATA_FIRST_OWNER_PACKAGE",
        "bound_pilot03_owner_freeze_identity": owner_freeze["g05_owner_freeze_identity"],
        "pool_status_preserved": "POOL_PENDING_INSUFFICIENT_INDEPENDENT_POSITIVE_FAMILIES",
        ...
        "owner_files_required": [
            {"filename": "owner-source-pilot04-v1.txt", "encoding": "UTF-8_NO_BOM", "line_endings": "LF_ONLY", "terminal_lf_count": 1, "content": "OWNER_AUTHORED_BYTE_EXACT_NEUTRAL_FACTUAL_SOURCE"},
            {"filename": "owner-declaration-pilot04-v1.json", "canonical_requirement": "UTF8_JSON_NO_BOM_LF_ONE_TERMINAL_LF", "content": "OWNER_COMPLETED_DECLARATION_FROM_TEMPLATE"},
        ],
        "source_content_requirements": {
            ...
            "prohibited": ["PILOT01_02_03_WORDING_ENTITY_EVENT_CREATIVE_PREMISE_OR_CONSTRUCTION_REUSE", "REVISION_SIBLING_SYNDICATION_OR_SAME_EVENT_RELATION_TO_PRIOR_PILOTS", "HUMOR_PUNCHLINE_RHETORICAL_QUESTION_PARODY", "METAPHOR_HEAVY_ANTHROPOMORPHIC_OR_MECHANISM_SHAPED_FRAMING", "GOVERNANCE_OR_INSTRUCTION_STYLE_LANGUAGE", "PERSONAL_PRIVATE_CONFIDENTIAL_SENSITIVE_OR_ALLEGATION_CONTENT", "THIRD_PARTY_COPYRIGHTED_SURFACE", "MECHANISM_OBLIGATION_OR_CREATIVE_PREMISE_METADATA"],
            "selection_must_not_use": ["TARGET_MECHANISM_OR_BATCH2_GAP", "POOL_SHORTCUT_CLOSURE_FRIENDLY_SOURCE_SHAPE", "GOVERNANCE_V2_CONSTRUCTOR_OBLIGATION", "PILOT01_02_03_SURFACES_OR_DIAGNOSTICS", "TARGET_FRIENDLY_TOPIC_GRAMMAR_PROPOSITION_TOPOLOGY_OR_SHAPE"],
        },
        "freshness_checks_after_submission": ["BYTE_HASH_AND_GIT_BLOB_DISTINCT_FROM_PILOTS_01_02_03", "NO_TRANSITIVE_SOURCE_EVENT_AUTHORITY_TOPIC_REVISION_SYNDICATION_OR_CREATIVE_FAMILY_RELATION", "NO_PRIOR_ASSIGNMENT_CONSTRUCTION_OR_DOWNSTREAM_EXPOSURE", "NO_BLIND_FAMILY_ACCESS", "CONTAMINATION_LEDGER_COMPLETE"],
        "prospective_path": ["STRICT_PREINGESTION_VALIDATION", "PROSPECTIVE_IDENTITIES_AND_UNSIGNED_SIGNING_PACKET", "OWNER_OPERATED_CUSTODIAL_SIGNATURES", "ATOMIC_IMMUTABLE_INGESTION", "G01A", "G01B", "SEPARATE_ASSIGNMENT_AND_CONSTRUCTION_DECISIONS_IF_ADMITTED"],
    ...
    request = {**request_core, "owner_input_request_identity": seal("B2_DEVELOPMENT_PILOT04_OWNER_INPUT_REQUEST_V1", request_core)}
    audit_core = {"schema_name": "batch2-development-pilot04-owner-input-request-audit-v1", "schema_version": "1.0.0", "owner_input_request_identity": request["owner_input_request_identity"], "content_free": True, "prior_pilots_preserved": True, "mechanism_neutral": True, "blind_material_accessed": False, "g04b_performed": False, "deterministic_blockers": [], "external_input_blocker": "OWNER_AUTHORED_SOURCE_BYTES_AND_COMPLETED_DECLARATION_REQUIRED", "audit_verdict": "PASS_CONTENT_FREE_STOP_REQUIRED"}
    audit = {**audit_core, "audit_identity": seal("B2_DEVELOPMENT_PILOT04_OWNER_INPUT_REQUEST_AUDIT_V1", audit_core)}
    write("humor-mechanics-batch2-development-pilot04-owner-declaration-template-v1.json", template)
    write("humor-mechanics-batch2-development-pilot04-owner-input-request-v1.json", request)
    write("humor-mechanics-batch2-development-pilot04-owner-input-request-audit-v1.json", audit)

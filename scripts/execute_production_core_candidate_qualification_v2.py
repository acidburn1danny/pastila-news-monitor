...
RUNNER = (
    ...
    / "src"
    / "pastila_scout"
    / "production_core_candidate_qualification_runner_v2.py"
)
LAUNCHER = ROOT / "scripts" / "run_production_core_candidate_qualification_v2.sh"
NAMES = (
    "production-core-comparative-qualification-generation-v2.json",
    "production-core-candidate-request-manifest-v2.json",
    "production-core-candidate-object-manifest-v2.json",
    "production-core-candidate-generation-qualification-v2.json",
)
PROMPTS = {
    "pastila-editor-core-v1.1-experimental": ROOT
    ...
    "pastila-editor-core-v1.2-experimental": ROOT
...
def main():
    ...
    ) != sources.get("scripts/execute_production_core_candidate_qualification_v2.py"):
    ...
    for label in ("A", "B"):
        ...
        checks = [
            ...
            *(
                ...
                for role, k in zip(("adapter_v1_1", "adapter_v1_2"), PROMPTS, strict=True)
            ),
        ]
        ids = []
        observed_objects = []

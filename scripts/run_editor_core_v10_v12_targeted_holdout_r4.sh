...
[[ ${EDITOR_CORE_R4_EVALUATION_OWNER_AUTHORIZED:-0} == 1 ]] || exit 3
...
EXPECTED_PARENT_COMMIT=753f635c21cf356343bb93561d7010d4a8d809a9
EXPECTED_PARENT_TREE=1012c3ef8b39735f77c721ad4e4371b6ac21cafb
...
EXPECTED_REQUESTS=0d2f4c5d44b76e1c405672825fd6e148f128ca99515fe2b638b27ddcbb2f0acd
EXPECTED_RUNNER=1bcafebea3f534a340629b98c585c2083707488fc7ee754ce145f3d8a8019f04
case "$CANDIDATE" in
  r2-step-9) EXPECTED_ADAPTER=c680d686f0b139e618d99fab235c62267caa9482df0efbccb44cb2c58c124f02 ;;
  r4-step-6) EXPECTED_ADAPTER=b33ad877554809d92e6a85ad1ce988d82fb047ae59ec504f820af020913cd032 ;;
  *) exit 4 ;;
esac
...
WORK="$(mktemp -d /tmp/editor-targeted-r4-eval.XXXXXXXX)"; ROOTFS="$WORK/rootfs"; mkdir "$ROOTFS"; child=""

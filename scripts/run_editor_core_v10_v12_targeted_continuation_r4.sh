...
[[ ${EDITOR_CORE_R4_TRAINING_OWNER_AUTHORIZED:-0} == 1 ]] || exit 3
...
ZERO_STEP=/mnt/c/pf9/scripts/launch_editor_core_v10_v12_targeted_r4_zero_step.py
REPOSITORY=/mnt/c/pf9
EXPECTED_SOURCE_COMMIT=4d55b41c591454305b95b2f32b4259d77b6f3db1
EXPECTED_SOURCE_TREE=d950f57fe89dc39e336176f9ae105186ead757fd
...
EXPECTED_CONFIG=c36a6e9db94fa50b79423013f2c356f14c6c6c4a3798222e4cf51c624b73d5b6
EXPECTED_HELPER=7026fe0ea99d54d0fc6caefd5ac4b6c1119e488b1cdc96336ce14387b7ffb433
EXPECTED_ZERO_STEP=bd873259a94df970916df666254033da8bb676305f7f5c5600a747df3f4ebe1b
EXPECTED_WORKER=a23f9a26e537334be538ba72259eb09b1d63f7d242b022a32c7786286f59178b
...
WORK="$(mktemp -d /tmp/editor-targeted-r4-train.XXXXXXXX)"; ROOTFS="$WORK/rootfs"; mkdir "$ROOTFS"; child=""

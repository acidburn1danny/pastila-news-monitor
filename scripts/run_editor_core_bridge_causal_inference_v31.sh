...
AUTHORITY="$REPOSITORY/docs/artifacts/editor-core-editorial-bridge-causal-inference-authority-v31.json"
VERIFIER="$REPOSITORY/scripts/verify_editor_core_bridge_causal_inference_authority_v31.py"; ROUTE="$REPOSITORY/scripts/run_editor_core_bridge_causal_inference_v31.sh"

"""Prepare the decision-ready G05 owner-review packet for Pilot 04 candidate 01."""
...
VOICE_COMMIT = "31c6a3bae013867c5a24165c403152dd0f7f442b"
...
def main() -> None:
    ...
    require(voice["voice_review_identity"] == "9705e8455dd4a027dced4d3d6ec7dc26d04d8ce0f3d74c47b42a0a4f0177be06", "Voice review")
    require(voice["voice_receipt_identity"] == "497debe1b780c2a14f405012ccd857540fa8db06c655f5cc0ed3b0b67ea5eb72", "Voice receipt")
    require(naturalness["g04a_verdict"] == "ROMANIAN_NATURALNESS_PASS", "G04A")
    require(g03c["pool_level_verdict"] == "POOL_PENDING_PILOT04_QUALITY_GATES_AND_SEPARATE_G04B_CERTIFICATION", "pool status")
    require(g03["reconciliation_classification"] == "TARGET_RECOVERED_DOMINANT", "G03 classification")

    core = {
        "schema_name": "batch2-development-pilot04-candidate01-g05-owner-review-request-v1",
        ...
        "owner_must_explicitly_confirm_or_reject": {
            ...
            "g04b_pool_certification_pending_status_is_accepted": None,
            "no_curriculum_training_runtime_or_production_eligibility_is_understood": None,
        },
        "closed_owner_decisions": [
            "APPROVE PILOT04 OWNER_FROZEN DEVELOPMENT_ONLY G04B_PENDING",
            "REJECT PILOT04 OWNER_FREEZE",
        ],
        "owner_decision": None,
        ...
        "authority_matrix": {key: False for key in ("owner_freeze", "curriculum_promotion", "model_exposure", "training", "runtime_integration", "production_routing", "candidate_repair", "candidate_rewrite", "candidate_regeneration", "g04b_pool_certification")},
    }
    request = {**core, "g05_owner_review_request_identity": seal("B2_DEVELOPMENT_PILOT04_CANDIDATE01_G05_OWNER_REVIEW_REQUEST_V1", core)}
    audit_core = {
        "schema_name": "batch2-development-pilot04-candidate01-g05-owner-review-request-audit-v1",
        "schema_version": "1.0.0",
    ...
    audit = {**audit_core, "audit_identity": seal("B2_DEVELOPMENT_PILOT04_CANDIDATE01_G05_OWNER_REVIEW_REQUEST_AUDIT_V1", audit_core)}
    for name, value in (("humor-mechanics-batch2-development-pilot04-candidate01-g05-owner-review-request-v1.json", request), ("humor-mechanics-batch2-development-pilot04-candidate01-g05-owner-review-request-audit-v1.json", audit)):

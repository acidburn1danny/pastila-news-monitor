...
AUTHORITY="$REPOSITORY/docs/artifacts/editor-core-editorial-bridge-causal-inference-authority-v1.json"
VERIFIER="$REPOSITORY/scripts/verify_editor_core_bridge_causal_inference_authority.py"; ROUTE="$REPOSITORY/scripts/run_editor_core_bridge_causal_inference.sh"

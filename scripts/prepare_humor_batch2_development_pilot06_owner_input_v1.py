"""Freeze content-free metadata-first owner input preparation for Pilot 06."""
...
GOVERNANCE_COMMIT = "01830eeed9eade1957e13b53b0ab9cc48e76e7ea"
...
def main() -> None:
    require(subprocess.check_output(["git", "rev-parse", "HEAD"], cwd=ROOT, text=True).strip() == GOVERNANCE_COMMIT, "HEAD")
    governance = load("docs/artifacts/humor-mechanics-batch2-reverse-disclosure-dependency-governance-v2.json")
    schema = load("docs/artifacts/humor-mechanics-batch2-reverse-disclosure-sufficiency-schema-v2.json")
    audit = load("docs/artifacts/humor-mechanics-batch2-reverse-disclosure-governance-v2-audit-v1.json")
    ...
    require(audit["audit_identity"] == "a79347b90d21bc2375cf5edb8dbfad40d96aca0c85bca513b5819a4cdd397889", "audit")
    require(audit["verdict"] == "PASS_SOURCE_ONLY_ZERO_CONSTRUCTION", "audit verdict")

    template_core = {
        "schema_name": "batch2-internally-owned-owner-input-pilot06-v1", "schema_version": "1.0.0",
        "pilot_id": "BATCH2-INTERNALLY-OWNED-DEVELOPMENT-PILOT-06",
        "source": {"filename": "owner-source-pilot06-v1.txt", "declared_encoding": "UTF-8", "bom": False,
        ...
        "source_status_declarations": {
            ...
            "source_was_not_selected_for_a_humor_mechanism_pool_target_or_obligation": "OWNER_MUST_CHOOSE_BOOLEAN",
            "source_was_not_shaped_using_reverse_disclosure_governance_or_sufficiency_predicates": "OWNER_MUST_CHOOSE_BOOLEAN",
            "source_contains_no_mechanism_obligation_creative_premise_or_candidate": "OWNER_MUST_CHOOSE_BOOLEAN",
            "source_has_no_revision_sibling_same_event_or_syndication_relationship_with_pilots_01_02_03_04_05": "OWNER_MUST_CHOOSE_BOOLEAN",
            "source_does_not_reuse_pilots_01_02_03_04_05_wording_entities_events_or_creative_structures": "OWNER_MUST_CHOOSE_BOOLEAN",
    ...
    template = {**template_core, "template_identity": seal("B2_DEVELOPMENT_PILOT06_OWNER_DECLARATION_TEMPLATE_V1", template_core)}
    request_core = {
        "schema_name": "batch2-development-pilot06-owner-input-request-v1", "schema_version": "1.0.0",
        "status": "BLOCKED_AWAITING_OWNER_INPUT", "preparation_verdict": "PASS_CONTENT_FREE_METADATA_FIRST_OWNER_PACKAGE",
        "bound_governance_commit": GOVERNANCE_COMMIT, "reverse_disclosure_governance_identity": governance["governance_identity"],
        "sufficiency_schema_identity": schema["schema_identity"], "remediation_audit_identity": audit["audit_identity"],
        "pilot05_preservation": "IMMUTABLE_NONPOSITIVE_G02C_REJECTION_UNCHANGED",
        "content_accessed": False, "source_family_created": False,
        "owner_files_required": [
            {"filename": "owner-source-pilot06-v1.txt", "encoding": "UTF-8_NO_BOM", "line_endings": "LF_ONLY",
             "terminal_lf_count": 1, "content": "OWNER_AUTHORED_BYTE_EXACT_NEUTRAL_FACTUAL_SOURCE"},
            {"filename": "owner-declaration-pilot06-v1.json", "canonical_requirement": "UTF8_JSON_NO_BOM_LF_ONE_TERMINAL_LF",
        ...
        "source_content_requirements": {
            ...
            "must_not_be_optimized_for_future_proposition_sufficiency": True,
            "prohibited": ["PILOT01_THROUGH_05_WORDING_ENTITY_EVENT_OR_CREATIVE_STRUCTURE_REUSE",
                           "REVISION_SIBLING_SYNDICATION_OR_SAME_EVENT_RELATION_TO_PRIOR_PILOTS",
                           "HUMOR_OR_MECHANISM_SHAPED_FRAMING", "GOVERNANCE_OR_INSTRUCTION_STYLE_LANGUAGE",
        ...
        "proposition_sufficiency_boundary": {
            "current_status": "NOT_PERFORMED", "earliest_permitted_time": "ONLY_AFTER_G01A_AND_G01B_PASS",
            "must_complete_before_assignment_or_constructor_release": True,
        ...
        "authority_matrix": {key: False for key in (
            "source_acquisition", "content_ingestion", "archive_write", "custodial_signing", "g01a_admission", "g01b_admission",
            "proposition_sufficiency_evaluation", "target_assignment", "obligation_assignment", "constructor_release", "construction",
            "generation", "g04b_pool_certification", "model_exposure", "training", "runtime_integration", "production_routing")},
    }
    request = {**request_core, "owner_input_request_identity": seal("B2_DEVELOPMENT_PILOT06_OWNER_INPUT_REQUEST_V1", request_core)}
    audit_core = {
        "schema_name": "batch2-development-pilot06-owner-input-request-audit-v1", "schema_version": "1.0.0",
        "owner_input_request_identity": request["owner_input_request_identity"], "content_free": True,
        "pilot05_preserved": True, "mechanism_neutral": True, "blind_material_accessed": False,
        "proposition_sufficiency_performed": False, "sufficiency_deferred_until_post_g01": True,
        "source_selection_uses_sufficiency_or_obligation": False, "assignment_or_construction_authority": False,
    ...
    request_audit = {**audit_core, "audit_identity": seal("B2_DEVELOPMENT_PILOT06_OWNER_INPUT_REQUEST_AUDIT_V1", audit_core)}
    write("humor-mechanics-batch2-development-pilot06-owner-declaration-template-v1.json", template)
    write("humor-mechanics-batch2-development-pilot06-owner-input-request-v1.json", request)
    write("humor-mechanics-batch2-development-pilot06-owner-input-request-audit-v1.json", request_audit)
    print(json.dumps({"status": request["status"], "preparation_verdict": request["preparation_verdict"],
                      ...
                      "template_identity": template["template_identity"], "audit_identity": request_audit["audit_identity"]}, sort_keys=True))

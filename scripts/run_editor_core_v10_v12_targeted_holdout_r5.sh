...
[[ ${EDITOR_CORE_R5_EVALUATION_OWNER_AUTHORIZED:-0} == 1 ]] || exit 3
...
EXPECTED_PARENT_COMMIT=3e285af538157a0ca0dc63e149aa1330adf5ac39
EXPECTED_PARENT_TREE=7e2ae298bd72a0499eae67db608e1a19c67679d6
...
EXPECTED_REQUESTS=c4eff85258569792dffac867abb5117f40ae9be1e857cbb0130eb71a0ec659e3
EXPECTED_RUNNER=ae972eff7ff3b455a01f42a9391d79bae279fee1fc0fe7614f965f4683e4c8ae
case "$CANDIDATE" in
  r2-step-9) EXPECTED_ADAPTER=c680d686f0b139e618d99fab235c62267caa9482df0efbccb44cb2c58c124f02 ;;
  r5-step-6) EXPECTED_ADAPTER=41e280f26688e3cc1afdf94622a16ff238fdca8c600c930105ed008c6cb43024 ;;
  *) exit 4 ;;
esac
...
[[ $("${GIT[@]}" rev-parse origin/successor/core-v2-v12-runner-binding-remediation) == "$EXPECTED_PARENT_COMMIT" ]] || exit 4
...
WORK="$(mktemp -d /tmp/editor-targeted-r5-eval.XXXXXXXX)"; ROOTFS="$WORK/rootfs"; mkdir "$ROOTFS"; child=""

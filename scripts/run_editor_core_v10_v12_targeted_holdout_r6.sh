...
[[ ${EDITOR_CORE_R6_EVALUATION_OWNER_AUTHORIZED:-0} == 1 ]] || exit 3
...
EXPECTED_PARENT_COMMIT=b1ec9a0ee56592beb0a0096c21ce5c298de31d1f
EXPECTED_PARENT_TREE=c2a03f511b94718bb93cb1159493fed7f0621aa0
...
EXPECTED_REQUESTS=c196772d7186222d288b7d31cbaee4b6d608d54d0a7d20a9973ce226a08c9f77
EXPECTED_RUNNER=b2e5a37f7f0f235244a38e42937e1ecc5c6579b76d0ac2d254bff4a365bd4075
case "$CANDIDATE" in
  r2-step-9) EXPECTED_ADAPTER=c680d686f0b139e618d99fab235c62267caa9482df0efbccb44cb2c58c124f02 ;;
  r6-step-6) EXPECTED_ADAPTER=28c21c47d39331cc1ad16e92ac111e49a4f6176e876fbffce22ef1a5bb56c703 ;;
  *) exit 4 ;;
esac
...
WORK="$(mktemp -d /tmp/editor-targeted-r6-eval.XXXXXXXX)"; ROOTFS="$WORK/rootfs"; mkdir "$ROOTFS"; child=""

"""Zero-step launcher validation for the Editor Core targeted R4 round.
...
ACTIVE_COMMIT = "bb255009141c8db182ee6c8d024b2ad8cecf3d9f"
ACTIVE_TREE = "ed0458e0569a185ff70c0666a77eb17ab0cc9429"
...
def validate_public_inputs() -> tuple[dict[str, object], dict[str, object], dict[str, object]]:
    ...
    audit_module = load_script(ROOT / "scripts" / "audit_editor_core_v10_v12_targeted_r4_corrective_pack.py", "targeted_r4_audit")
    ...
    if (
        ...
        or config.get("rejected_r3_adapter_training_use") is not False
    ):
...
def zero_step(model: Path, checkpoint: Path, rootfs: Path, snapshot: Path, output: Path) -> dict[str, object]:
    ...
    core = {
        "schema": "pastila-editor-core-targeted-r4-zero-step-receipt",
        "schema_version": 1,

"""Prepare and audit the zero-construction Pilot 03 Governance V2 assignment."""
...
ADMISSION_COMMIT = "ea1397958e96ea5e2c5bd65acb98495bd0dd409b"
...
def main() -> None:
    require(subprocess.check_output(["git", "rev-parse", "HEAD"], cwd=ROOT, text=True).strip() == ADMISSION_COMMIT,
            "HEAD differs from Pilot 03 admission commit")
    admission = load(ADMISSION_COMMIT, "docs/artifacts/humor-mechanics-batch2-development-pilot03-g01a-g01b-admission-v1.json")
    ...
    require(admission["admission_identity"] == "ade1c0aeafa9daf04b1cb1fb7c6f8fdf06dc2a7bc3bf8fd247cc3261f56bd65a", "admission identity")
    ...
    require(governance["future_source_rule"]["pilot03_must_be_fresh_independently_acquired_and_admitted"] is True, "fresh family")
    ...
    assignment_core = {
        "schema_name": "batch2-development-pilot03-sealed-assignment-mapping-v1",
        ...
        "selection_analysis": {
            ...
            "fresh_family_independent_of_pilots_01_and_02": True,
    ...
    assignment_id = seal("B2_DEVELOPMENT_PILOT03_SEALED_ASSIGNMENT_V1", assignment_core)
    mapping = {**assignment_core, "sealed_assignment_identity": assignment_id}
    obligation_instance = seal("B2_DEVELOPMENT_PILOT03_UNLABELED_OBLIGATION_INSTANCE_V1", {
        "assignment": assignment_id,
        "family": package["family_identities"]["family_closure"],
        "version": governance["constructor_visible_obligation"]["obligation_version"],
    })
    packet_core = {
        "schema_name": "batch2-development-pilot03-constructor-facing-assignment-proposal-v1",
        "schema_version": "1.0.0",
        "admission_identity": admission["admission_identity"],
        ...
        "mapping_commitment": seal("B2_DEVELOPMENT_PILOT03_MAPPING_COMMITMENT_V1", mapping),
    ...
    packet_id = seal("B2_DEVELOPMENT_PILOT03_CONSTRUCTOR_PACKET_V1", packet_core)
    ...
    audit_core = {
        "schema_name": "batch2-development-pilot03-assignment-design-leakage-audit-v1", "schema_version": "1.0.0",
        ...
        "pilot01_and_pilot02_contamination": "ABSENT_NO_SURFACE_CONSTRUCTION_OR_DIAGNOSTIC_REUSE",
    ...
    audit = {**audit_core, "audit_identity": seal("B2_DEVELOPMENT_PILOT03_ASSIGNMENT_DESIGN_AUDIT_V1", audit_core)}
    write("humor-mechanics-batch2-development-pilot03-sealed-assignment-mapping-v1.json", mapping)
    write("humor-mechanics-batch2-development-pilot03-constructor-facing-assignment-proposal-v1.json", packet)
    write("humor-mechanics-batch2-development-pilot03-assignment-design-leakage-audit-v1.json", audit)

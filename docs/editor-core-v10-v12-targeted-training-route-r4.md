# Editor Core V10 V1.2 targeted R4 training route

The dedicated R4 worker consumes exactly the published 48-row corpus: 36
...
and byte-binds the R4 worker, published R4 zero-step

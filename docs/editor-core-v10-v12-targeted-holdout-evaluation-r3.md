# Editor Core V10 V1.2 targeted R3 holdout evaluation

This independent development evaluation compares the selected R2 step-9
development parent with the R3 step-6 adapter on the frozen 12-case R3 holdout.
...
adapters, request corpus, runner, exact published R3 training-route parent,

"""Sign the V14 pre-consumption launcher source without granting an attempt."""
...
OUTPUT = ROOT / "docs/artifacts/production-core-v14-preconsumption-launcher-boundary"
SOURCE_FILES = (
    ...
    "scripts/audit_production_core_v14_preconsumption_preflight.py",
    "scripts/audit_production_core_v14_launcher_boundary.py",
    "scripts/audit_production_core_successor_attempt_authority_v14.py",
    "scripts/materialize_production_core_successor_attempt_authority_v14.py",
    ...
    "src/pastila_scout/production_core_overnight_supervisor_v14.py",
...
AUTHORITY_ID = "27955b01b3254a08679b200a3f20d4c5d382f582834b98119f701f37cc86b5ec"
...
def build() -> dict:
    ...
    v14 = audit_v14.audit(Path("/unused"), Path("/unused"), Path("/unused"), Path("/unused"), recompute=False)
    if v14["authority_identity"] != AUTHORITY_ID:
        raise ValueError("V14 successor authority mismatch")
    sources = {}
    ...
    core = {
        "schema": "pastila-production-core-v14-preconsumption-launcher-boundary",
        "schema_version": 1,
        "status": "SIGNED_PREFLIGHT_ONLY_ZERO_ATTEMPTS",
        "bound_published_commit": preflight.COMMIT,
        "bound_published_tree": preflight.TREE,
        "v14_authority_identity": v14["authority_identity"],
        "v14_binding_identity": v14["binding_identity"],
        "v14_signature_identity": v14["signature_identity"],
...
def binding_for(boundary: dict, raw: bytes) -> dict:
    return {
        "schema": "pastila-production-core-v14-preconsumption-launcher-binding",
        "schema_version": 1,
        "algorithm": "Ed25519",
        ...
        "bound_published_commit": preflight.COMMIT,
        "bound_published_tree": preflight.TREE,
        "v14_authority_identity": AUTHORITY_ID,
...
def materialize(private_key: Path, output: Path = OUTPUT) -> dict[str, str]:
    ...
    with tempfile.TemporaryDirectory(prefix=".v14-launcher-", dir=output.parent) as temporary:

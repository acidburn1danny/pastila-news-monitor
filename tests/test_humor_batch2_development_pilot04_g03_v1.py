"""Verify Pilot 04 blind G03 freeze and reconciliation."""
...
def test_pilot04_g03_is_blind_valid_and_target_dominant() -> None:
    prefix = "humor-mechanics-batch2-development-pilot04-candidate01-g03-"
    ...
    for value, field, namespace in (
        ...
        (opened, "pass_identity", "B2_DEVELOPMENT_PILOT04_G03_OPEN_PASS_V1"),
        ...
        (reconciliation, "reconciliation_identity", "B2_DEVELOPMENT_PILOT04_G03_RECONCILIATION_V1"),
        (receipt, "g03_receipt_identity", "B2_DEVELOPMENT_PILOT04_G03_RECEIPT_V1"),
    ):

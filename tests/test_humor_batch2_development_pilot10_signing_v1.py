...
SCRIPT = ROOT / "scripts/owner_humor_batch2_development_pilot10_signing_v1.py"


def load_module():
    spec = importlib.util.spec_from_file_location("pilot10_signing", SCRIPT)
...
def test_frozen_packet_inputs_are_byte_exact_at_preparation_commit():
    module = load_module()
    paths = [module.PACKET, module.PROSPECTIVE, module.INDEPENDENCE, module.REGISTRATION]
    for path in paths:

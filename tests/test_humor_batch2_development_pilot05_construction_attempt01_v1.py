"""Verify the frozen one-shot Pilot 05 construction evidence."""
...
def test_pilot05_attempt_is_exactly_once_and_byte_bound() -> None:
    evidence = json.loads((ART / "humor-mechanics-batch2-development-pilot05-construction-attempt01-v1.json").read_text(encoding="utf-8"))
    candidate = (ART / "humor-mechanics-batch2-development-pilot05-candidate01-v1.txt").read_bytes()
    core = dict(evidence); identity = core.pop("evidence_identity")
    assert seal("B2_DEVELOPMENT_PILOT05_CONSTRUCTION_ATTEMPT01_V1", core) == identity
    ...
    expected_candidate = seal("B2_DEVELOPMENT_PILOT05_CANDIDATE_V1", {
    ...
    expected_family = seal("B2_CREATIVE_PREMISE_FAMILY_V1", {
        "sealed_assignment_identity": "17fe47e507801352f5892d03e3fd4faa8fec9535202f05a90f1e337c87f89e75",

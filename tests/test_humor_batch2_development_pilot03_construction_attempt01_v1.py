"""Verify the frozen one-shot Pilot 03 construction evidence."""
...
def test_pilot03_attempt_is_exactly_once_and_byte_bound() -> None:
    evidence = json.loads((ART / "humor-mechanics-batch2-development-pilot03-construction-attempt01-v1.json").read_text(encoding="utf-8"))
    candidate = (ART / "humor-mechanics-batch2-development-pilot03-candidate01-v1.txt").read_bytes()
    core = dict(evidence); identity = core.pop("evidence_identity")
    assert seal("B2_DEVELOPMENT_PILOT03_CONSTRUCTION_ATTEMPT01_V1", core) == identity
    ...
    expected_candidate = seal("B2_DEVELOPMENT_PILOT03_CANDIDATE_V1", {
    ...
    expected_family = seal("B2_CREATIVE_PREMISE_FAMILY_V1", {
        "sealed_assignment_identity": "dce3d5321e2008b7a4a4cf02b1632e23fcd11cc8f6932d95f4fc3c4eb6c642a4",

...
SCRIPT = ROOT / "scripts/owner_humor_batch2_development_pilot08_signing_v1.py"


def load_module():
    spec = importlib.util.spec_from_file_location("pilot08_signing", SCRIPT)
...
def test_secret_and_response_paths_must_be_outside_repository(tmp_path: Path) -> None:
    module = load_module()
